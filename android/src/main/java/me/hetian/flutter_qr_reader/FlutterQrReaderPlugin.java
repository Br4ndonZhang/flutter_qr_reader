...
//  }
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
        ...
        PlatformViewRegistry registrar = binding.getPlatformViewRegistry();
        registrar.registerViewFactory(CHANNEL_VIEW_NAME, new QrReaderFactory(binding.getBinaryMessenger()));
